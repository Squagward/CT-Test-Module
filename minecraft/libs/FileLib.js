...
register("command", () => {
  ...
  FileLib.write(
    "./config/ChatTriggers/modules/TestModule/folder/file3.txt",
    "Also should be written!",
    true
  );
  FileLib.write(
    "TestModule",
    "folder/deeply/nested/file4.txt",
    "This should be written as well!",
    true
  );
  ...
  console.assert(
    FileLib.read("TestModule", "file1.txt") === "Hello World!\n2nd line"
  );
  console.assert(
    FileLib.read(
      "./config/ChatTriggers/modules/TestModule/folder/file3.txt"
